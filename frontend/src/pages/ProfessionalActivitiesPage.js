    ...
    <Box>
      ...
      <TabPanel value={tabValue} index={0}>
        <GenericCRUDPage
          ...
          initialFormData={{ roleType: '', venueName: '', year: '', isQ1Q2Reviewer: false }}
        />
      </TabPanel>
      ...
      <TabPanel value={tabValue} index={1}>
        <GenericCRUDPage
          ...
          initialFormData={{ eventTitle: '', durationCategory: '', startDate: '', endDate: '' }}
        />
      </TabPanel>
      ...
      <TabPanel value={tabValue} index={2}>
        <GenericCRUDPage
          ...
          initialFormData={{ title: '', organization: '', date: '' }}
        />
      </TabPanel>
    </Box>
  );
